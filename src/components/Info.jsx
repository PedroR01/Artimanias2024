        ...
        <main>
          {knowMore ? ( //Cambiar de pestañas con el bool KnowMore
            <article className="m-6 items-center justify-center rounded-md folder-window-shadow border-2 border-black bg-[#E2A1FF]">
              ...
              <button 
                className="w-3/4 py-3 px-15 bg-white rounded-2xl bebas-neue-regular folder-window-shadow border-2 border-black text-black text-center font-bold text-2xl hover:text-gray-300 hover:outline-gray-300" 
            ...
            <article className="m-10 bg-white rounded-md folder-window-shadow border-2 border-black hover:border-gray">
                ...
                <div className="flex p-2 bg-[#D1C1B4] rounded-md">
                    <h3 className="font-bold text-white bebas-neue-regular text-2xl"> SEDE FONSECA - DIAGONAL 78 ESQ. 62 </h3>
                </div>
            </article>
          )}
